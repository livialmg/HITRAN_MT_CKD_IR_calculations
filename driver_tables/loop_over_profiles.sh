...
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=olr_${pro}_${version}_lev_*_4.1.txt
*END
EOF
...
*OUT
  OUTDIR=../output/comparison/r0.1/
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=olr_${pro}_${version}_lev_*_3.2.txt
*END
EOF
...
*OUT
  OUTDIR=../output/comparison/r0.1/
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=olr_${pro}_${version}_lev_*_4.1_woBFX.txt
*END
EOF
...
*OUT
  OUTDIR=../output/comparison/r0.1/
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=olr_${pro}_${version}_lev_*_3.2_woBFX.txt
*END
EOF
...
*OUT
  OUTDIR=../output/comparison/r0.1/
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=dlr_${pro}_${version}_lev_*_4.1.txt
*END
EOF
...
*OUT
  OUTDIR=../output/comparison/r0.1/
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=dlr_${pro}_${version}_lev_*_3.2.txt
*END
EOF
...
*OUT
  OUTDIR=../output/comparison/r0.1/
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=dlr_${pro}_${version}_lev_*_4.1_woBFX.txt
*END
EOF
...
*OUT
  OUTDIR=../output/comparison/r0.1/
!COOFIL=coo_${pro}_${version}_lev_*.txt
  RADFIL=dlr_${pro}_${version}_lev_*_3.2_woBFX.txt
*END
EOF
...
echo Running RFM to "$pro" profile, using HITRAN "$version"
echo Using MT_CKD 4.1 water vapor continuum for cooling rates


cat << EOF > rfm.drv
!DATE 12/01/2024 - DRIVER TABLE
!PRIMARY SECTIONS
*HDR		     !Header text for output files
OLR - comparison of hitran 2016 and 2020
*FLG		     !Flags (Apendice B)
...
*OUT
  OUTDIR=../output/comparison/r0.1/
  COOFIL=coo_${pro}_${version}_lev_*_4.1.txt
*END
EOF
...
echo Running RFM to "$pro" profile, using HITRAN "$version"
echo Using MT_CKD 3.2 water vapor continuum for cooling rates
...
*OUT
  OUTDIR=../output/comparison/r0.1/
  COOFIL=coo_${pro}_${version}_lev_*_3.2.txt
*END
EOF
